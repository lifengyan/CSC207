...
public class MainFunction {
  ...
  public static String genericSoftPath =
      new File("src/phaseone/traversal_table.csv").getAbsolutePath();
  ...
  public static void main(String[] args) {
    ...
    System.out.println(hrFilePath
        .equals("/h/u7/c7/04/zhutong1/207Project/group_0411/project/A3/src/phase1/hrfile.csv"));
          ...
          if (userInput[2].equals("ready")) {
            ...
            if (!pickerManager.getPicker(userInput[1]).equals(null)) {
              if (!userInput[3].equals("8")) {
                ...
                System.out.println("Picker" + userInput[1] + " go to location: "
